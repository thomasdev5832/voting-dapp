...
// config Ethers -> integrate smart contract in front-end
const contractAddress = '0x23908A11AF4ac69C18BF3C45a7b28fBc64d2F756';
const contractABI = [
    {
      "inputs": [],
...
const getAllCandidates = async function() {
    ...
    tableHeader.innerHTML = `<th>ID Nº</th>
                            <th>Candidate</th>`;
...
const startElection = async function() {
    ...
    const _votingDuration = ethers.utils.parseUnits(electionDuration.value);
